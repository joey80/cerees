...
function EpisodeModal({ Plot, Released, Title }: IGetEpisode) {
  return (
    <div className="absolute bg-white overflow-hidden border custom-border-color border-dashed top-0 mt-14 p-3 w-80 h-56 z-10 text-sm rounded-xl drop-shadow-xl">
      <ul>
